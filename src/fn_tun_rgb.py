...
rgb_train_ds = get_dataset(root_ds, split=0, ds_file=ds_file, batch_size=BATCH_SIZE)
rgb_test_ds = get_dataset(root_ds, split=1, debug=False, ds_file=ds_file, batch_size=BATCH_SIZE)
rgb_val_ds = get_dataset(root_ds, split=2, debug=True, ds_file=ds_file, batch_size=BATCH_SIZE)
